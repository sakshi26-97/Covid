...
export type ThunkAction<R = void, A extends Action = AnyAction> = _ThunkAction<R, CombinedState, {}, A>;

export type ThunkDispatch<E = void, A extends Action = AnyAction> = _ThunkDispatch<CombinedState, E, A>;
