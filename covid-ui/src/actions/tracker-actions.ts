...
const trackerActions = {
    ...
    getCountByCountrySuccess: (data: CountByCountry[]) => createAction(TrackerAactionTypes.GET_COUNT_BY_COUNTRY_SUCCESS, { data }),
...
export const getCountriesAsync = (): ThunkAction => async (dispatch): Promise<void> => {
...
export const getCountByCountryAsync = (countryName: string): ThunkAction => async (dispatch): Promise<void> => {
...
export const getSummaryAsync = (): ThunkAction => async (dispatch): Promise<void> => {
