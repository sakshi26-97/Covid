...
const vaccinationActions = {
    ...
    getLiveCountSuccess: (data: { count: number }) => createAction(VaccinationAactionTypes.GET_LIVE_COUNT_SUCCESS, { data }),
    ...
    searchByDistrictSuccess: (data: Center[]) => createAction(VaccinationAactionTypes.SEARCH_BY_DISTRICT_SUCCESS, { data }),
    ...
    getVaccinationReportSuccess: (data: VaccinationReport) => createAction(VaccinationAactionTypes.GET_VACCINATION_REPORT_SUCCESS, { data }),
    getVaccinationReportFailed: (error: any) => createAction(VaccinationAactionTypes.GET_VACCINATION_REPORT_FAILURE, { error }),
}

export type VaccinationActions = ActionUnion<typeof vaccinationActions>;

export const getLiveCountAsync = (): ThunkAction => async (dispatch): Promise<void> => {
...
export const getStatesAsync = (): ThunkAction => async (dispatch): Promise<void> => {
...
export const getDistrictsAsync = (stateId: string): ThunkAction => async (dispatch): Promise<void> => {
...
export const searchByPinAsync = (pincode: string, date: string): ThunkAction => async (dispatch): Promise<void> => {
    dispatch(vaccinationActions.searchByPin());

    try {
        const response = (await axios.get(`${consts.COVID_BACKEND_URL}/vaccination/search/pin?pincode=${pincode}&date=${date}`)).data;
...
export const searchByDistrictAsync = (districtId: string, date: string): ThunkAction => async (dispatch): Promise<void> => {
    dispatch(vaccinationActions.searchByDistrict());

    try {
        const response = (await axios.get(`${consts.COVID_BACKEND_URL}/vaccination/search/district?districtId=${districtId}&date=${date}`)).data;
...
export const getVaccinationReportAsync = (): ThunkAction => async (dispatch): Promise<void> => {
