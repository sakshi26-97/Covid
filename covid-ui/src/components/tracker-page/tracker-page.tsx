...
export default class TrackerComponent extends React.PureComponent<Props, TrackerState> {
	...
	public render(): JSX.Element {
		...
		const { countryError, countryName, globalChartData, globalChartOptions, countryChartData, countryChartOptions } =
			this.state;
									...
									<Grid container justifyContent="center" spacing={4}>
										<Grid item>
											<Autocomplete
												id="country"
												disableClearable
												options={countries.sort((country1, country2) => {
										...
										<Grid item>
											<Button variant="contained" onClick={this.getDetailsByCountry} className="search-button">
												Search
											</Button>
										</Grid>
									</Grid>
